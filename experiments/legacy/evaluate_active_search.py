...
def run_one(key, out, case, seed, item, room, memory):
    args = SimpleNamespace(
        case=case, seed=seed, item=item, room=room, memory=memory, seconds=120.0, budget=0.15
    )
        ...
        json.dumps(
            {
                ...
                "seconds": 120,
                "workers": 3,
                "depth": "ideal, 120 degree cone",
                "semantics": "15% dropout, first two wooden sightings ambiguous",
