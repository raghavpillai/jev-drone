...
class InspectionNavigation(Navigation):
    ...
    def decide(self,sim,target,extra=None):
        ...
        if self.observed_target:
            ...
            extra["target_observation"]={"appearance":obj["appearance"],
                "last_seen_at":obj["last_seen_at"],
                "surface_offset_forward_left_up_m":[round(v,2) for v in subtract(obj["visible_surface_xyz"],sim.position)],
...
class InspectionExperiment(AllJevExperiment):
    def __init__(self,args,gateway):
        ...
        self.nav=InspectionNavigation(gateway,args.memory,args.limited,args.degraded,args.seed)
