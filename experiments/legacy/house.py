...
WAYPOINTS = {
    ...
    "door_living_side": {
        "xyz": [5.5, 6, 1],
        "description": "Approach the connecting doorway from inside the living room.",
    },
    "door_bedroom_side": {
        "xyz": [8.5, 6, 1],
        "description": "Exit the connecting doorway inside the bedroom.",
    },
...
DESTINATIONS = {
    "bedroom": {
        "room": "bedroom",
        "xyz": [11, 9.5, 1],
        "description": "Stop at the bedroom's destination marker.",
    },
    "living_room_bookshelf": {
        "room": "living_room",
        "object_xyz": [2, 10.8, 1.4],
        "xyz": [2, 9.2, 1],
        "description": "Stop in front of the bookshelf in the living room. xyz is its approach point, not inside the shelf.",
    },
}
...
def world(destination, start_room="living_room"):
    obstacles = (
        Box((6.8, 0, 0), (7.2, 4, 4)),
        Box((6.8, 8, 0), (7.2, 12, 4)),
        Box((1, 10.4, 0), (3, 11.2, 2.8)),
        Box((3.6, 3.8, 0), (4.4, 4.6, 4)),
        Box((9.2, 7.1, 0), (10.2, 8.1, 1.8)),
    )
    start = (2.0, 2.0, 1.0) if start_room == "living_room" else (11.0, 9.5, 1.0)
    return Scenario(
        "house", 0, start, tuple(DESTINATIONS[destination]["xyz"]), obstacles, (14.0, 12.0, 4.0)
    )
