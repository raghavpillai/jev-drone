...
def main():
    ...
    parser.add_argument('--item',choices=['bookcase','bed','plant','cabinet','table'],default='bookcase')
    parser.add_argument('--room',choices=['living_room','bedroom','study','anywhere'],default='bedroom')
    parser.add_argument('--variation',choices=['original','mirror_x','mirror_y','mirror_xy','east_wall','west_wall'],default='original')
