...
def test_memory_describes_search_without_selecting_or_removing_tasks():
    ...
    state = {
        ...
        "options": {
            "view_bedroom_0_0_1.3": {"position": [7.5, 1.0, 1.3]},
            "give_up": {"purpose": "terminate"},
        },
    }
    ...
    assert described["options"]["view_bedroom_0_0_1.3"]["position"] == [7.5, 1.0, 1.3]
