...
class Config(PolicyConfig):
    ...
    command_lease_seconds: float = 0.9
    slow_clearance_m: float = 0.7
    creep_clearance_m: float = 0.4
    full_clearance_m: float = 1.5
    stopping_margin: bool = True
    braking_settling_allowance_s: float = 0.7
    patch_encoding: str = "changed_channels"
    goal_horizontal_tolerance_m: float = 0.35
    goal_vertical_tolerance_m: float = 0.15
