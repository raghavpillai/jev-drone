...
class Layout:
    ...
    def bounds(self):
        return (
            np.min([v[0] for v in self.rooms.values()], axis=0),
...
SMALL = Layout(
    {
        "living": ((0, 0, 0), (6, 8, 4)),
        "bedroom": ((6, 0, 0), (12, 4, 4)),
        "study": ((6, 4, 0), (12, 8, 4)),
    },
    {"living_bedroom": (6, 2, 1.3), "living_study": (6, 6, 1.3), "bedroom_study": (9, 4, 1.3)},
    {
        "living_bedroom": ("living", "bedroom"),
        "living_study": ("living", "study"),
...
HOUSE = Layout(
    {
        ...
        for y, row in enumerate(
            (("entry", "living", "dining", "kitchen"), ("study", "bedroom", "library", "workshop"))
        )
        for x, name in enumerate(row)
    },
    {
        "entry_living": (6, 3, 1.3),
        "living_dining": (12, 3, 1.3),
        "dining_kitchen": (18, 3, 1.3),
        "study_bedroom": (6, 9, 1.3),
        "bedroom_library": (12, 9, 1.3),
        "library_workshop": (18, 9, 1.3),
        "entry_study": (3, 6, 1.3),
        "living_bedroom": (9, 6, 1.3),
        "dining_library": (15, 6, 1.3),
        "kitchen_workshop": (21, 6, 1.3),
    },
    {
